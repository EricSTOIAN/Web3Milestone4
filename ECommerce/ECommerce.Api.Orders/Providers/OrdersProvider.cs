...
namespace ECommerce.Api.Orders.Providers
{
    public class OrdersProvider : IOrdersProvider
    {
        ...
        public async Task<(bool IsSuccess, IEnumerable<Orders.Models.Order> Orders, string ErrorMessage)> GetOrdersAsync()
        {
            try
            {
        ...
        public async Task<(bool IsSuccess, IEnumerable<Orders.Models.Order> Orders, string ErrorMessage)> GetOrdersAsync(int customerId)
        {
            try
            {
